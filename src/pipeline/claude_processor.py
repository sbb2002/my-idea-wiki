...
- body: 개요(summary)에서 소개한 내용을 항목별로 상세 설명. 마크다운 형식으로 작성하되 소제목(##)과 본문으로 구성. 최소 2개 이상의 소제목 항목을 포함할 것.
  첨부 이미지가 있을 경우, body 내 적절한 위치에 ![설명](attachment:파일명) 형식으로 인라인 삽입할 수 있습니다.
